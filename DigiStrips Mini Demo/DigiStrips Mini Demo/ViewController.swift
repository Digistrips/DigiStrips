...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        view.backgroundColor = UIColor(red: 21/255.0, green: 85/255.0, blue: 154/255.0, alpha: 1.0)
        ...
        //        whiteModalView.translatesAutoresizingMaskIntoConstraints = false
        //        NSLayoutConstraint.activate([
        //            whiteModalView.topAnchor.constraint(equalTo: view.topAnchor,constant: 250),
        //            whiteModalView.centerXAnchor.constraint(equalTo: view.centerXAnchor),
        //            whiteModalView.widthAnchor.constraint(equalToConstant: UIScreen.main.bounds.width-60),
        //            whiteModalView.heightAnchor.constraint(equalToConstant: 250)])
        //        whiteModalView.backgroundColor = UIColor.white
        //        whiteModalView.alpha = 0.7
        //        whiteModalView.layer.borderColor = UIColor.white.cgColor
        //        whiteModalView.layer.cornerRadius = 5.0
        //        whiteModalView.layer.shadowColor = UIColor.black.cgColor
        //        whiteModalView.layer.shadowOpacity = 0.4
        //        whiteModalView.layer.shadowOffset = CGSize.zero
        //        whiteModalView.layer.shadowRadius = 4
    ...
    @objc func UTIbuttonWasTapped(_ gesture: UITapGestureRecognizer){
        ...
        //        navigationController?.pushViewController(UTIView, animated: true)
